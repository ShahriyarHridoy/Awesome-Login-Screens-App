                              ...
                              FadeAnimation(
                                ...
                                InkWell(
                                  ...
                                  child: Text(
                                    ...
                                    style: TextStyle(
                                        fontSize: 12.0, color: darkGreyColor),
                                  ),
                                ),
                              ),
                              const SizedBox(
              ...
              children: [
                  ...
                  Padding(
                    ...
                    child: Card(
                      ...
                      child: Container(
                        ...
                        decoration: BoxDecoration(
                          color: Colors.white,
                          border: Border.all(width: 3, color: basicColor),
                ...
                Row(
                  ...
                  children: [
                    FadeAnimation(
                      3.4,
                      cardCircular(nameImage: 'gmail'),
                    ),
                    FadeAnimation(
                      3.6,
                      cardCircular(nameImage: 'facebook (1)', size: 55),
                    ),
                    FadeAnimation(
                      3.8,
                      cardCircular(nameImage: 'instagram (2)', size: 80),
                    ),
                  ],
                ),
